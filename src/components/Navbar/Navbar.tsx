...
const Navbar = () =>
{
    ...
    return (
        <div className={Style.NavBar}>
            <div className={Style.NavBar_box}>
                ...
                <div className={Style.NavBar_box_right}>
                    ...
                    <div className={Style.NavBar_box_right_connect}>
                        {account === "" ? ( <button onClick={connectWallet}> <span>Connect Wallet</span></button> ) : ( <button onClick={() => setOpenModel( true )}> {""} <Image src={userName ? images.accountName : images.create2} alt='image' width={20} height={20} /> <small>{userName || "Create Account"}</small></button> )}
                    </div>
            ...
            {/* MODAL COMPONENT */}
            {openModel && ( <div className={Style.modelBox}>
